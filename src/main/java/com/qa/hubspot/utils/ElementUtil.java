...
public class ElementUtil {
	...
	public WebElement waitForSingleElementToBeVisible(By locator, int timeOut) {
		WebDriverWait wait = new WebDriverWait(driver, timeOut);
	...
	public boolean waitTillAttributeContains(By locator, int timeOut, String attribute, String value) {
		WebDriverWait wait = new WebDriverWait(driver, timeOut);
